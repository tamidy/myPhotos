...
const FileUpload = () => {
    ...
    const submitFile = async () => {
      try {
        ...
        // handle success
        let test : string = (document.getElementById("uploadFeedback") as HTMLInputElement).innerHTML = "Success!";

      } catch (error) {
        // handle error
        let test : string = (document.getElementById("uploadFeedback") as HTMLInputElement).innerHTML = "No file uploaded";
      }
    };
